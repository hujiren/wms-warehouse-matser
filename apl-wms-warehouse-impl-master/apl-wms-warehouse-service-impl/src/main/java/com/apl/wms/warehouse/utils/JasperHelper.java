...
public class JasperHelper {
	...
	public static void prepareReport(JasperReport jasperReport, String type) {
		// logger.debug("The method======= prepareReport()
		// start.......................");
		/*
	...
	public static void exportExcel(JasperPrint jasperPrint, String defaultFilename, HttpServletRequest request,
		...
		response.setHeader("Content-Disposition",
				"attachment; filename=\"" + URLEncoder.encode(defaultname, "UTF-8") + "\"");
	...
	private static void exportBase64Pdf(JasperPrint jasperPrint, String defaultFilename, HttpServletRequest request,
			HttpServletResponse response) throws IOException, JRException {
		...
		//base64pdf = encoder.encode(bytes);
	}
	...
	public static void export(String type, String defaultFilename, File is, HttpServletRequest request,
		...
		try {
			...
			} else if (PDF_BASE64.equals(type)) {
				exportBase64Pdf(jasperPrint, defaultFilename, request, response);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void export(String type, String defaultFilename, File reportTemplateFile, HttpServletRequest request,
							  HttpServletResponse response, Map parameters, java.util.List datas) throws IOException, JRException {

		JRDataSource jrDataSource = new JRBeanCollectionDataSource(datas);
		JasperHelper.export(type, defaultFilename, reportTemplateFile, request, response, parameters, jrDataSource);
	}

		public static void export(String type, String defaultFilename, File reportTemplateFile, HttpServletRequest request,
			HttpServletResponse response, Map parameters, JRDataSource conn) throws IOException, JRException {
	 ...
	 */
	public static void showHtml(String defaultFilename, String reportfile, HttpServletRequest request,
	...
	public static void showPdf(String defaultFilename, String reportfile, HttpServletRequest request,
			HttpServletResponse response, Map parameters, Connection conn) throws JRException, IOException {
